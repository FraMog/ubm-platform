...
<body>
			...
			<div class="col-sm-3">
				...
				<div class="row">
					...
					<div class="col-sm-12">
						...
						<h5>
							<a data-toggle="modal" data-target="#vediFeedbackModal">Visualizza
					...
					<div class="col-sm-12">
						<h5>
							...
							<%=profileToShow.getNome()%>? <a data-toggle="modal"
								data-target="#inserisciFeedbackModal">Inserisci un Feedback!</a>
						</h5>

						<h5>
							<a data-toggle="modal" data-target="#modificaFeedbackModal">Modifica
								un Feedback!</a>
						</h5>
					</div>
				...
				<button type="button" class="btn btn-warning"
					onclick="javascript:invalidaAccountA('<%=email%>')">Invalida</button>
				<button type="button" class="btn btn-danger"
					onclick="javascript:cancellaAccountA('<%=email%>')">Cancella</button>
				<%
					}
				%>
				...
				<div class="panel-body risultato">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-2">
							<img src="img/annunci/<%=annunciPertinenti.get(i).getFoto()%>"
								alt="Foto" class="img-responsive center-block modalImageClasse">
						</div>
						...
						<div class="col-xs-12 col-sm-2 pull-right">
							...
							<p>
								Data pubblicazione:
								<%=new java.text.SimpleDateFormat("dd-MM-yyyy").format(data).substring(0, 10)%>
								alle
								<%=new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(data).substring(10, 19)%></p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<div class="formgroup col-sm-12">
						<div class="col-sm-9" id="viewFeedbackLogger"></div>
						<div class="col-sm-3">
							<button type="button" class="btn btn-warning"
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<div class="formgroup col-sm-12">
						...
						<div class="col-sm-6" id="buttonsInserisci">
				...
				<form action="ModificaFeedbackServlet" method="POST">
					...
					<div class="modal-footer">
						...
						<div class="formgroup col-sm-12">
							...
							<div class="col-sm-6" id="buttonsChange">
								<button type="button" class="btn btn-primary"
	...
	<script src="javascript/feedback/visualizzaFeedbacks.js"></script>

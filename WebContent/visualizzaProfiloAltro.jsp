	...
	<section class="col-sm-10" id="section">
		<div class="row">
			<img id="profile_picture" class="img-responsive col-sm-2"
				src="img/default_profile.PNG" alt="Foto del profilo"
				title="Giovanni Ciampi" />
			<div class="col-sm-7">
				<h1>Giovanni Ciampi</h1>
				<h3>
					E-mail: <a href="mailto:g.ciampi5@studenti.unisa.it" id="email">g.ciampi5@studenti.unisa.it</a>
				</h3>
					...
					<div class="col-sm-12">
						<h5>
							Hai fatto affari con Giovanni? <a data-toggle="modal"
								data-target="#modificaFeedbackModal">Inserisci un Feedback!</a>
						</h5>
					</div>
				</div>
		...
		<div id="content" class="panel panel-default">
			<div class="panel-body risultato">
				<img src="img/annunci/libro.jpg" alt="libro"
					class="img-responsive col-sm-2">
				<div class="col-sm-8">
					<h4>
						<a href="#">Object oriented software engineering</a>
					</h4>
					<p>Libro utilizzato per il corso di ingegneria del software
						tenuto dalla professoresa Ferrucci. Tenuto in ottimo stato e non
						sottolineato</p>
				</div>
				...
				<div class="modal-body">
					<div class="form-group">
						...
						<textarea style="overflow: auto; resize: none"
							class="form-control" rows="5" id="descrizioneFeedback"
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<div class="formgroup col-sm-12">
						...
						<div class="col-sm-6">
							<button type="button" class="btn btn-primary" id="buttonModifica">Modifica</button>
							<button type="button" class="btn btn-warning"
								data-dismiss="modal">Annulla</button>
						</div>
					</div>

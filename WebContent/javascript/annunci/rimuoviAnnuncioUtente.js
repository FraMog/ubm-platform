...
function rimuoviAnnuncioUtente(id){
	$('#rimuoviModal').modal('hide'); //nascondo il modal di conferma
	//effettuo la richiesta con ajax
	$.ajax({type:"GET",
		url: "CancellaAnnuncioServlet?annuncioID="+id,
